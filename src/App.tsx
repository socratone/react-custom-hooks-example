...
import UseInputAdvanced from './pages/UseInputAdvanced';
  ...
  return (
    <div>
      <MainNav>
        ...
        <MainNavItem to="/use_input_advanced">UseInputAdvanced</MainNavItem>
        <MainNavItem to="/use_get">UseGet</MainNavItem>
      </MainNav>
      <Routes>
        <Route path="/use_input" element={<UseInput />} />
        <Route path="/use_input_advanced" element={<UseInputAdvanced />} />
